                ...
                <div class="main-header__inner">
                    ...
                    <nav class="main-header__nav main-menu">
                        <ul class="main-menu__list one-page-scroll-menu">
                            ...
                            <li class="scrollToLink"><a href="https://test-dreams.dreamhosters.com/hurricane-relief#home">HURRICANE RELIEF</a></li>
                            <!--- <li class="scrollToLink"><a href="login.php">Login</a></li>--->
                        </ul>
                    </nav>
                    <div class="main-header__right">
                        <button type="button" class="main-header__right__btn eolimn-btn" data-bs-toggle="modal" data-bs-target="#joinModal">
                            Join us today <i class="icon-arrow-point-to-right"></i>
                        </button>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-9">
                                    <div class="main-slider-one__content">
                                        ...
                                        <div class="main-slider-one__btn">
                                            <a href="#join-us" data-bs-toggle="modal" data-bs-target="#joinModal" class="eolimn-btn eolimn-btn--base">Join Us Today<i class="icon-arrow-point-to-right"></i></a>
                                ...
                                <div class="col-lg-3">
                                    <div class="main-slider-one__video">
                                        <a href="https://youtube.com/watch?v=2uHdj6d1rSs" class="main-slider-one__video__popup video-popup"> play </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-9">
                                    <div class="main-slider-one__content">
                                        ...
                                        <div class="main-slider-one__btn">
                                            <a href="https://forms.gle/YG6ut3knKA6FSGsY6" class="eolimn-btn eolimn-btn--base">general contracting platform <i class="icon-arrow-point-to-right"></i></a></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="joinModalLabel">Join Us Form</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- Added id="join-us" to the form -->
                <form id="join-us" action="NewMembersData.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="reason" id="reason" placeholder="Tell us why you want to join"></textarea>
                    </div>
...
<!--                                </div>-->
                    ...
                    <div class="col-lg-6">
                        <div class="about-one__content">
                            ...
                            <p class="about-one__top__text">Our mission is to empower individuals and communities embrace cleaner, environmentally-friendly energy sources. </br></br>Through education and training, we aim to create a new generation of clean energy leaders, particularly in underserved communities. Our goal is to provide the necessary resources and support to kickstart careers in sustainable energy solutions.</p>
...
<!--                            </ul>-->
                            ...
                            <a href="https://forms.gle/qmnaZfXHjMQP2UhS9" class="eolimn-btn">Enroll Now<i class="icon-arrow-point-to-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                            </ul>-->
                            ...
                            <a href="https://forms.gle/YG6ut3knKA6FSGsY6" class="eolimn-btn">sign up <i class="icon-arrow-point-to-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                            </ul>-->
                            ...
                            <a href="https://forms.gle/vsua7KahgSgCqDEn7" class="eolimn-btn">Enroll Now<i class="icon-arrow-point-to-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
